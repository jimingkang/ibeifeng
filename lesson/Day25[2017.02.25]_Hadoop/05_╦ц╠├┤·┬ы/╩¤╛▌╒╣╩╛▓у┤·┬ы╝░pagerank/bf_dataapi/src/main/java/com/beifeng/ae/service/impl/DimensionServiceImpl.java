...
public class DimensionServiceImpl implements DimensionService {
    ...
    @Override
    public PlatformDimension getPlatformDimension(final String platformName, final String version) {
        return this.platformDimeDao.getPlatformDimension(platformName, version);
    }
