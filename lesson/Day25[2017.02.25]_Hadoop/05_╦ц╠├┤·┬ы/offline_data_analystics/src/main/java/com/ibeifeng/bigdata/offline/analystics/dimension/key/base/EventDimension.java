package com.ibeifeng.bigdata.offline.analystics.dimension.key.base;
...
public class EventDimension extends BaseDimension {
	...
	public String toString() {
		return "EventDimension [id=" + id + ", category=" + category
				+ ", action=" + action + ", originId=" + originId
				+ ", hasMultChidren=" + hasMultChidren + ", flowId=" + flowId
				+ ", seq=" + seq + "]";
	}
}
